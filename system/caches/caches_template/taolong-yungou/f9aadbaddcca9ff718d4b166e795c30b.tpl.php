...
<div class="header">
	<div class="site_top">
		...
		<ul class="login_info" style="display: block;">
            ...
            <li class="h_help"><a href="<?php echo G_WEB_PATH; ?>/?/go/index/app" target="_blank">手机APP</a></li>
            <li class="h_help"><a href="<?php echo G_WEB_PATH; ?>/?/go/index/intro" target="_blank"><?php echo _cfg('web_name_two'); ?>简介</a></li>
