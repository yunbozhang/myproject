...
<div class="banner_recommend">
	...
	<div class="banner_right">
		<div class="m_login">
			<a href="/?/single/newbie"><img src="<?php echo G_TEMPLATES_IMAGE; ?>/index-come.gif" width="208" height="108"></a>
		</div>
		<div class="m_app">
			<ul>
	...
	<ul id="readyLotteryItems" class="hot-list">
		...
		<li class="list-block">
			...
			<div class="shop_buttom">
				<a href="<?php echo WEB_PATH; ?>/goods/<?php echo $shop['id']; ?>" target="_blank" class="shop_but" title="立即购买"></a>
