...
<div class="layout980">
	<div class="groups-left">
		<h2 class="gr-title"><a><b><?php echo _cfg('web_name_two'); ?>圈子</b></a></h2>
		<div class="gr-guild">
			<b>在这里可以做什么?</b>
			<p class="gray01">在这里你可以找到与自己兴致相投的<?php echo _cfg('web_name_two'); ?>网友，随意申请加入任何你感兴趣的圈子，了解<?php echo _cfg('web_name_two'); ?>所发生的“重大事件”，参与到他们的行列之中，一起探论<?php echo _cfg('web_name_two'); ?>神奇，看看他们是如何<?php echo _cfg('web_name_two'); ?>的，一起分享交流探讨！来！一起加入他们的行列中吧！</p>
		</div>
