...
<head>
    ...
    <title><?php echo _cfg('web_name_two'); ?>结果 - <?php echo $webname; ?>触屏版</title>
...
<!-- 内页顶部 -->
    ...
    <header class="g-header">
        ...
        <h2><?php echo _cfg('web_name_two'); ?>结果</h2>
        <div class="head-r">
		...
		<div class="u-Btn"><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/home/userbuylist" class="z-CloseBtn">查看<?php echo _cfg('web_name_two'); ?>记录</a></div><div class="u-Btn-li"><a href="<?php echo WEB_PATH; ?>/mobile/mobile" class="z-DefineBtn">继续购物</a></div></div>		 
		</section>
    </div>
