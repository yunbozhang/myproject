	...
	<div id="ltlContents" class="help-right-part">
		<div class="help-right-part">
			<div class="help-in-rihgt-part">
				...
				<style>
				.help-nav ul li a.cur<?php echo $article['id']; ?>{color:#db3752;  position:relative; font-weight:bold;}
				.help-nav ul li a.cur<?php echo $article['id']; ?> b{width:4px; height:4px; overflow:hidden; background:#db3752; display:inline-block; position:absolute; left:-10px; top:5px;}
				</style>
