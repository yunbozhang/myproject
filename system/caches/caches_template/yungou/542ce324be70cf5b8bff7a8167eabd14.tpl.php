		...
		<div class="Pro_Detright">
			...
			<div class="Pro_Record">
				...
				<div class="Newest_Con hide" style="display:none;">
					...
					<p class="MsgIntro1"><?php echo _cfg("web_name_two"); ?>以“快乐<?php echo _cfg('web_name_two'); ?>，惊喜无限”为宗旨，力求打造一个100%公平公正、100%正品保障、寄娱乐与购物一体化的新型购物网站。<a href="<?php echo WEB_PATH; ?>/help/1" class="blue" target="_blank">查看详情&gt;&gt;</a></p>
				</div>
			</div>			
		</div>
	</div>
