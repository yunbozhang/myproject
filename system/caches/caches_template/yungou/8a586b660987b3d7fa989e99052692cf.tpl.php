	...
	<div id="divInfo0" class="New-content">
		...
		<div class="scroll-list">
			<div class="R-tit">
				...
				<i>在<?php echo microt($go['time'],"r"); ?><?php echo _cfg('web_name_two'); ?>了</i>
			...
			<div class="buy-com">
				...
				<div class="buy-rcon">                 	
					...
					<p class="buy-code gray02">幸运<?php echo _cfg('web_name_two'); ?>码：<span class="orange"><?php echo $jiexiao['q_user_code']; ?></span></p>
