...
<!-- 内页顶部 -->
	     ...
	     <li class="m-xs-li" txt="<?php echo $shop['time_H']; ?>点">
            <div class="m-round limit-bd limit-End">
                ...
                <div class="clearfix gray9 limit-user">
                    ...
                    <p class="m-limit-Code">幸运<?php echo _cfg('web_name_two'); ?>码：<em class="orange"><?php echo $shop['q_user_code']; ?></em>
                    </p>
                    <p>
                        <?php echo _cfg('web_name_two'); ?>人次：<?php echo $user_shop_number[$shop['q_uid']][$shop['id']]; ?>
                    </p>
                </div>
            </div>
        </li>
            ...
            <div class="m-round limit-bd ">
                ...
                <div class="u-Btn">
				   <?php if($shop['canyurenshu']==$shop['zongrenshu']): ?>
					...
					<?php  else: ?>
					<div class="u-Btn-li">
						<a href="javascript:;" class="z-ShoppingBtn" id="<?php echo $shop['id']; ?>">立即<?php echo _cfg('web_name_two'); ?></a>
					</div>
					<div class="u-Btn-li">
	...
	<article class="clearfix mt10 m-round limit-tips">
		...
		<div class="limit-tips-ct">
			...
			<p><s></s><b>如果计算出的<?php echo _cfg('web_name_two'); ?>码未被购买，则取差值最小的<?php echo _cfg('web_name_two'); ?>码作为幸运<?php echo _cfg('web_name_two'); ?>码。</b></p>
			<p><s></s><b>如果有2个<?php echo _cfg('web_name_two'); ?>码最小差值相等，则取大值作为最终幸运<?php echo _cfg('web_name_two'); ?>码。</b></p>
			<p><s></s><b>限时揭晓商品不参与差价送福分活动且晒单不可再获得1000福分奖励。</b></p>
			<p><s></s><b>限时揭晓的幸运<?php echo _cfg('web_name_two'); ?>码计算方式：</b></p>
			  <em><span>1)</span><b>限时揭晓商品取截止时间前网站所有商品100条购买时间记录。</b></em>
			  <em><span>2)</span><b>时间按时、分、秒、毫秒依次排列组成一组数值。</b></em>
			  <em><span>3)</span><b>将这100组数值之和除以商品总需参与人次后取余数，余数加上10,000,001即为“幸运<?php echo _cfg('web_name_two'); ?>码”。</b></em>
		</div>
	</article>
</section>
