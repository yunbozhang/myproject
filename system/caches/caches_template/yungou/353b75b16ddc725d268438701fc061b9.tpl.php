...
<div class="R-content">
	...
	<div id="GoodsList" class="goods_show">
		...
		<ul class="goods_list">	
			...
			<li class="joinInfo" style="margin:23px 0 0 0;"><p><em><?php echo $rt['gonumber']; ?></em>人次</p></li>
			<li class="do" style="margin:23px 0 0 0;"><a href="<?php echo WEB_PATH; ?>/member/home/userbuydetail/<?php echo $rt['id']; ?>" class="blue" title="查看购买码">查看<?php echo _cfg('web_name_two'); ?>码</a></li>
		</ul>
		<?php endif; ?>
