...
.user_see_code{border-radius:5px; position:absolute; right:10px; width:75px; text-align:center; height:25px; line-height:25px; background:#ca1b38; cursor:pointer; display:none;}
</style>
</head>
<body style="width:970px; min-height:35px;  padding-top:20px;background-color:#fff">
		...
		<div class="AllRecW AllReclist"><div class="AllRecL fl"><?php echo microt($user['time']); ?><i></i></div>
			...
			<p class="AllRecR_T">            	
				...
				<?php endif; ?>
				<?php echo _cfg('web_name_two'); ?>了<em class="Fb orange"><?php echo $user['gonumber']; ?></em>人次
				</span>     
                <span class="user_see_code" see="off">查看<?php echo _cfg('web_name_two'); ?>码</span>           
			</p>
