    ...
    <section class="clearfix g-member">
        ...
        <div class="R-content">
            ...
            <div id="divInvited" class="success-invitation gray02"  >
                ...
                <span><input id="txtInfo"  style="width:80%;height:20px; " disabled="disabled" value="1元就能买IPhone 6哦，快去看看吧！ <?php echo WEB_PATH; ?>/register/<?php echo $uid; ?>" onpaste="return false" type="text"><span id="d_clip_container"><button id="d_clip_button" class="">复制123</button></span></span>
