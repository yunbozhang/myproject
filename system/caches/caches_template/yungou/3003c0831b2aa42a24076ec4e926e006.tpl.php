...
<div class="help-main">
	<div class="qqGroup">
		<div class="qqTitle">
			...
			<span>为打造更具公平、透明的<?php echo _cfg('web_name_two'); ?>平台，<?php echo _cfg('web_name_two'); ?>特成立各地QQ交流群（可在选择框查找本地群），欢迎广大<?php echo _cfg('web_name_two'); ?>朋友加入。<br>
			另外，<?php echo _cfg('web_name_two'); ?>正在招募各地群主加盟，也可自建群，具体待遇和要求请咨询QQ:<?php echo _cfg("qq"); ?></span>
		</div>
