...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   <title>桌面版_<?php echo _cfg('web_name_two'); ?></title>
...
<body>
    <div class="tContent">
        <div class="tMain">
            <div class="tHead">
                <ul>
                    <li class="tLogo"><a href="<?php echo G_WEB_PATH; ?>" class="tHome"><img src="<?php echo G_UPLOAD_PATH; ?>/logo2.png" /></a><img src="app/images/line.gif" class="line" /><a href="/?/go/index/desktop" title="桌面版" class="txt">桌面版</a></li>
                    <li class="tNav">
                        <a href="<?php echo G_WEB_PATH; ?>" title="1元云购首页" class="tReturn">1元云购首页</a>
                        <a href="<?php echo G_WEB_PATH; ?>/?/go/index/touch" title="触屏版" >触屏版</a>
                        <a href="<?php echo G_WEB_PATH; ?>/?/go/index/app" title="手机版">手机版</a>
                        <a href="<?php echo G_WEB_PATH; ?>/?/go/index/desktop" title="桌面版" class="current">桌面版</a>
                        <a href="<?php echo G_WEB_PATH; ?>/?/go/index/weixin" title="微信关注">微信关注</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="tImg2">
            <div class="tImg">
                <ul>
                    <li class="img1"></li>
                    <li class="img2"></li>
                    <li class="img3"><a href="1yyg_desktop.exe" title="免费下载" target="_blank"></a></li>
                </ul>
            </div>
        </div>
        <div class="tMain">
            <div class="tStep">
                <div class="tTitle">下载安装只需两步</div>
                <ul>
                    <li>
                        <dd class="mt30"><img src="app/images/pic_12.jpg" /></dd>
                        <dd><img src="app/images/pic_14.jpg" /></dd>
                    </li>
                    <li>
                        <dd class="mt10"><img src="app/images/pic_16.jpg" /></dd>
                        <dd><img src="app/images/pic_18.jpg" /></dd>
                    </li>
                </ul>
            </div>
      </div>
