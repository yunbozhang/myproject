...
<div class="d"><div>
	<div class="site_top">
        ...
        <p class="collect"><a class="gray01" href="<?php echo G_WEB_PATH; ?>/?/go/index/weixin" target="_blank">官方微信</a></p>
        <p class="collect"><a class="gray01" href="<?php echo G_WEB_PATH; ?>/?/go/index/intro" target="_blank"><?php echo _cfg('web_name_two'); ?>简介</a></p>
        <p class="collect"><a class="gray01" href="<?php echo G_WEB_PATH; ?>/?/go/index/app" target="_blank">手机版</a></p>
