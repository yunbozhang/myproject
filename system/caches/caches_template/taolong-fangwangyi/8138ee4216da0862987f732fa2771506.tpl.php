	...
	<div class="service_date">
   		...
   		<div class="Service_Fund">
   			<a href="<?php echo WEB_PATH; ?>/single/fund" target="_blank">
   				<p><?php echo _cfg('web_name_two'); ?>公益基金</p>
...
<div class="footer" style="height:auto;">
	...
	<div class="footer_icon" style="width:599px;">
		<ul>
			...
			<li class="fi_315online"><a target="_blank" href="http://www.yungoucms.com/get.php?url=<?php echo G_WEB_PATH; ?>"><span><?php echo _cfg('web_name_two'); ?>商业授权值得信赖</span></a></li>
...
<div id="divRighTool" class="quickBack">
	...
	<dl class="quick_But">
		...
		<a id="btnMyCart" href="<?php echo WEB_PATH; ?>/member/cart/cartlist" target="_blank" class="quick_cartA">
			<b>购物车</b><s></s><em>0</em>
		</a>
