...
<head>
    ...
    <title>触屏手机版_<?php echo _cfg('web_name_two'); ?></title>
...
<body>
    <div class="tContent">
        <div class="tMain">
            <div class="tHead">
                <ul>
                    <li class="tLogo"><a href="<?php echo G_WEB_PATH; ?>" class="tHome"><img src="<?php echo G_UPLOAD_PATH; ?>/logo2.png" /></a><img src="app/images/line.gif" class="line" /><a href="/?/go/index/touch" title="触屏版" class="txt">触屏版</a></li>
                    <li class="tNav">
                        <a href="<?php echo G_WEB_PATH; ?>" title="1元云购首页" class="tReturn">1元云购首页</a>
                        <a href="<?php echo G_WEB_PATH; ?>/?/go/index/touch" title="触屏版" class="current">触屏版</a>
            ...
            <div class="tPic">
                <img src="app/images/pic_03.jpg?v=0902" />
                <img src="app/images/pic_05.jpg?v=0902" />
                <img src="app/images/pic_06.jpg?v=0902" />
                <img src="app/images/pic_07.jpg?v=0902" />
            </div>
            <div class="tInfo">
