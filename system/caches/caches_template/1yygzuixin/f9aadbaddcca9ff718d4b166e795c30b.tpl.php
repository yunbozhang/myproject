...
<meta property="qc:admins" content="13537423606111576375" />
</head>
<body>
<style>  
 .g-snow-con {
	...
	<div class="g-frame-top">
		<div class="g-width head-nav-bd">
			<ul class="head-nav-bd-l">
                ...
                <li class="M-attention menu">
					<div class="menu-hd">
						<a href="<?php echo G_WEB_PATH; ?>/?/go/index/intro"
							target="_blank"><?php echo _cfg('web_name_two'); ?>简介</a>
					</div>
				</li>
                
                <li class="M-attention menu">
					<div class="menu-hd">
						<a href="<?php echo G_WEB_PATH; ?>/?/go/index/app"
							target="_blank">手机APP</a>
					</div>
				</li>
			...
			<?php  else: ?>
             <li id="liLoginBox" class="M-login menu"><div class="menu-hd">
						<a rel="nofollow" href="javascript:;" class="gray6 loginQQs">QQ登录</a>
					</div></li>
			 <li id="liLoginBox" class="M-login menu"><div class="menu-hd">
						<a rel="nofollow" href="javascript:;" class="gray6 loginBtn">登录</a>
					</div></li>
			 <li id="liRegisterBox" class="M-login menu"><div class="menu-hd">
						<a rel="nofollow" href="javascript:;" class="gray6 regBtn">注册</a>
					</div></li>
			<?php endif; ?>
				...
				<!--<li class="F-invitation menu">
					<div class="menu-hd">
						<a href="<?php echo G_WEB_PATH; ?>/?/go/index/weixin"target="_blank">官方微信</a>
					</div>
				</li>
				<li class="mod_sitemap_gap"></li>-->
				<!--<li class="F-invitation menu">
				...
				<div class="head_search">
					<div class="top_search">
						<input type="text" id="txtSearch" class="init" value='输入"iphone"试一试'
							placeholder="" style="color: rgb(187, 187, 187);"> 
...
var getAllNum = function(){
	...
	var b = a.text();
	$.ajax({
		url: "<?php echo WEB_PATH; ?>/api/ajaxcount/buy_count",
		type:"POST",
