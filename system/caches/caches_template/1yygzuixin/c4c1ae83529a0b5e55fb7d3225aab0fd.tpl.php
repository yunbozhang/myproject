...
.g-frame-top, .g-frame-head, .g-frame-content, .g-frame-footer {width: 100%;min-width: 1190px;}
...
<script type="text/javascript" src="<?php echo G_TEMPLATES_STYLE; ?>/js/scroll.js"></script>
               ...
               <div class="home-event fr">
                    <div class="what-1yyg">
                        <a id="what_1yyg" href="javascript:void(0);" title="什么是1元云购？30秒了解" >
                            <img src="<?php echo G_TEMPLATES_STYLE; ?>/images/index-come.gif" alt=""></a>
                    </div>
                    <div class="honesty">
                        <ul>
            ...
            <div class="g-list">
				...
				<?php 
				 ...
				 ?>
					...
					<?php  endforeach; $ln++; unset($ln); ?>
					<script type="text/javascript" src="<?php echo G_TEMPLATES_STYLE; ?>/js/GLotteryFun.js"></script>
